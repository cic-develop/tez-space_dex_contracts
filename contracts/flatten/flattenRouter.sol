            ...
            uint(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"fe45d3baeb07327d663118e59cca429b1d58964756f55222590c9ebd73dcffc3" // init code hash
                    )
                )
            )
        );
...
// File contracts/P3DexRouter02.sol
...
contract P3DexRouter02 is IUniswapV2Router02 {
    using SafeMath for uint;
    ...
    function _addLiquidity(
        ...
        require(
            ...
            "UniswapV2Router: PAIR_NOT_EXIST"
        );
